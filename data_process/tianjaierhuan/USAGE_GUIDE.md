# Tianjiaerhuan Event Data Annotation System - Usage Guide

## Overview
This system provides comprehensive multi-dimensional annotation for social media posts related to the Tianjiaerhuan event using both LLM-based and traditional NLP methods.

## Key Features

### 1. Time Range Filtering
- **Range**: 2025-05-15 00:00:00 to 2025-05-19 23:59:59
...
3. **Stance**: 支持/反对/中立 (towards "黄杨钿甜佩戴耳环的行为")
...
pip install -r data_process/tianjaierhuan/requirements_annotation.txt
...
Edit `data_process/tianjaierhuan/config.json`:
```json
{
  "llm": {
    "api_configs": [
...
```bash
# Run annotation only
python data_process/tianjaierhuan/annotator.py

# Or run full pipeline (annotation + visualization)
python data_process/tianjaierhuan/run_annotation.py
```

### Step 3: Generate Visualizations
```bash
python data_process/tianjaierhuan/visualizer.py
```
...
```
Loading data from data_process/tianjaierhuan/output/base_data.json...
Total posts extracted: 105974
Posts in time range (2025-05-15 to 2025-05-19): 45230
Valid posts (after filtering short/empty content): 42150
  - Filtered out: 3080 posts
Already annotated: 0
To annotate: 42150
Time range: 2025-05-15 00:00:00 to 2025-05-19 23:59:59
...
[FAILED] Post abc12345... | Time: 2025-05-17 10:30:00 | Reason: LLM API failed
```
