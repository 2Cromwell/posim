# Wudatushuguan Event Data Annotation System - Usage Guide

## Overview
This system provides comprehensive multi-dimensional annotation for social media posts related to the Wudatushuguan (武大图书馆) event using both LLM-based and traditional NLP methods.

## Key Features

### 1. Time Range Filtering
- **Range**: 2025-07-17 00:00:00 to 2025-07-30 06:00:00
...
3. **Stance**: 支持/反对/中立 (towards "武大图书馆事件")
...
pip install -r data_process/wudatushuguan/requirements_annotation.txt
...
Edit `data_process/wudatushuguan/config.json`:
```json
{
  "llm": {
    "api_configs": [
...
```bash
# Run annotation only
python data_process/wudatushuguan/annotator.py

# Or run full pipeline (annotation + visualization)
python data_process/wudatushuguan/run_annotation.py
```

### Step 3: Generate Visualizations
```bash
python data_process/wudatushuguan/visualizer.py
```
...
```
Loading data from data_process/wudatushuguan/output/base_data.json...
Total posts extracted: 105974
Posts in time range (2025-07-17 to 2025-07-30): 45230
Valid posts (after filtering short/empty content): 42150
  - Filtered out: 3080 posts
Already annotated: 0
To annotate: 42150
Time range: 2025-07-17 00:00:00 to 2025-07-30 06:00:00
...
[FAILED] Post abc12345... | Time: 2025-07-28 10:30:00 | Reason: LLM API failed
```
